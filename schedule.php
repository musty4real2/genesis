  <?php include("header.php"); ?>
            ...
            <div class="page-head">
                ...
                <span class="sub-title">Welcome to schedule</span>
            ...
            <div class="container"> 
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select class="form-control" name="Type" placeholder="Type"> Select Type
                                <option value='Type'>Type</option>
                                <option value='Appointment'>Appointment</option>
                                <option value='Meeting'>Meeting</option>
                                <option value='Task'>Birthday/Anniversary</option>
                                <option value='Activity'>Thanksgiving</option>
                            </select>
                        </div>
                    </div>
                    </div>
                        <br />
                           ...
                           <div class="row">
                                  <div class="col-md-3">
                                   ...
                                   <div class="col-lg-4">
                                       <div class="form-group">
							             <select class="form-control" name="Time" placeholder="TIme">Select Time</option>
                              ...
                              <div class="row">
                                     <div class="col-lg-10">
                                          <input type="Venue" class="form-control" name="Title" placeholder="Title">
                                      </div>
                                 </div>
                                 <br />
                                ...
                                <div class="row">
                                     <div class="col-lg-10">
                                          <input type="Venue" class="form-control" name="Venue" placeholder="Venue">
                                      </div>
                                 </div>
                                 <br />
